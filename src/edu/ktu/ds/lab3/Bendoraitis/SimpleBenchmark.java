 ...
 */
package edu.ktu.ds.lab3.Bendoraitis;

import edu.ktu.ds.lab3.Bendoraitis.Book;
import edu.ktu.ds.lab3.Bendoraitis.BooksGenerator;
            ...
            for (int k : COUNTS) {
               ...
               // timekeeper.finish(BENCHMARK_NAMES[0]);
                ...
                for (int i = 0; i < set.length; i++) {
                    vocabulary3.remove((String)set[i]);
                }
                long usedMemory3 = runtime.totalMemory() - runtime.freeMemory() - usedMemoryBefore;
                timekeeper.finish(BENCHMARK_NAMES[0]);
                usedMemoryBefore = runtime.totalMemory() - runtime.freeMemory();
                set = vocabulary2.keySet().toArray();
                for (int i = 0; i < set.length; i++) {
                    vocabulary2.remove(set[i]);
                }
